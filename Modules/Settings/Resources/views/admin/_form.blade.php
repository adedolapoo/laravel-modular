        ...
        <div class="tab-pane active" id="tab_1">
            <div class="form-group">
                <div class="row">
                    @if(!empty($data->image))
                        <div class="col-3">
                            <img class="image" src="{{asset('uploads/settings/'.$data->image)}}" alt="" style="width:250px;">
            ...
            {!! form_row($form->website_title) !!}
            {!! form_row($form->app_name) !!}
            {!! form_row($form->website) !!}
            {!! form_row($form->welcome_message) !!}
            {!! form_row($form->google_analytics) !!}
            {!! form_row($form->tawk_plugin) !!}
            {!! form_row($form->youtube_video_code) !!}
        </div>
    </div>
</div>
