...
use Modules\Lcds\Http\Requests\FormRequest;
use Modules\Lcds\Repositories\LcdInterface as Repository;
use Modules\Lcds\Entities\Lcd;

class LcdsController extends BaseAdminController {
    ...
    public function edit(Lcd $model)
        {
    ...
    public function update(Lcd $model,FormRequest $request)
    {
        $data = $request->all();
