...
class BusinessesController extends BaseAdminController {
    ...
    public function edit(Business $model)
        {
    ...
    public function update(Business $model,FormRequest $request)
    {
        $data = $request->all();
