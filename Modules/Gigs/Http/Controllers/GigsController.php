...
use Modules\Gigs\Http\Requests\FormRequest;
use Modules\Gigs\Repositories\GigInterface as Repository;
use Modules\Gigs\Entities\Gig;

class GigsController extends BaseAdminController {
    ...
    public function edit(Gig $model)
        {
    ...
    public function update(Gig $model,FormRequest $request)
    {
        $data = $request->all();
