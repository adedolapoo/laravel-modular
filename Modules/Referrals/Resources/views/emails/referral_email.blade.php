                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                        <td class="content-block"
                            ...
                            valign="top">
                            You are invited to join Mactay Gigs!
                        </td>
                    </tr>
                    ...
                    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                        <td class="content-block"
                            ...
                            valign="top">
                            <p>
                                Your friend {{$user->first_name}} {{$user->last_name}} has invited you to join Mactay Gigs.
                                MacTay Gig is a talent engagement platform that provides leading organisations with an agile
                                alternative to traditional project recruitment. We provide the best trained and the most talented professionals
                                the flexibility to align their personal and professional goals.
                                Bring your expertise to any team on your terms.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                        <td class="content-block"
                            style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                            valign="top">
                            <a href="{{ config('myapp.website','https://mactaygig.com') }}"
                               class="btn-primary"
                               style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background: #d30e00; margin: 0; padding: 0; border-color: #d30e00; border-style: solid; border-width: 10px 20px;">
                                Start using Mactay Gigs
                            </a>
                        </td>
                    </tr>
