...
use Modules\Lovs\Http\Requests\FormRequest;
use Modules\Lovs\Repositories\LovInterface as Repository;
use Modules\Lovs\Entities\Lov;

class LovsController extends BaseAdminController {
    ...
    public function edit(Lov $model)
        {
    ...
    public function update(Lov $model,FormRequest $request)
    {
        $data = $request->all();
