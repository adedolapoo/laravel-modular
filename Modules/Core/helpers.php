...
function generate_datatable($table_headings,$action_columm = true){
    $str = '';
...
function unformat_date($userDate = null)
{
    if ($userDate)
    {
        $date = \Carbon\Carbon::parse($userDate);
...
function get_post_categories()
{
    ...
    return $model->select('all', false,'category','category_id');
}
