...
class TalentsController extends BaseAdminController {
    ...
    public function edit(Talent $model)
        {
    ...
    public function update(Talent $model,FormRequest $request)
    {
        $data = $request->all();
